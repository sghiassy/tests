...
public class JSONAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Boolean viewAlreadyExists = convertView != null;
        ...
        Boolean objectHasImage = jsonObject.has("cover_i");
        ...
        if (objectHasImage) {
            ...
            // Temporarily have a placeholder in case its slow to load
        ...
        // Send these String to the TextView for display
